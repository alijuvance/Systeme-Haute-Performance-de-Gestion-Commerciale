...
export const PurchasesTable: React.FC<PurchasesTableProps> = ({ data, isLoading, error }) => {
  if (error) return <div className="text-red-500 p-4">{error}</div>;
  if (isLoading) return <div className="p-4 animate-pulse">Chargement des achats...</div>;
