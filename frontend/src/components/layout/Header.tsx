  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 sticky top-0 z-10 flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-6">
        <div className="hidden md:flex items-center bg-slate-50 border border-slate-200 px-3 py-1.5 focus-within:border-slate-400 focus-within:bg-white transition-colors">
        ...
        <div className="w-8 h-8 bg-slate-900 text-white flex items-center justify-center font-medium text-xs cursor-pointer">
          AD
        </div>
      </div>
    </header>
